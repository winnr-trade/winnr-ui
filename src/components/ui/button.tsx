  ...
  "inline-flex items-center justify-center rounded-none text-base font-sans font-bold transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-surface-bright text-white hover:bg-surface-bright/80",
        destructive:
        ...
        outcome: "rounded-none bg-transparent border border-border text-muted-foreground hover:text-white data-[active=true]:bg-primary data-[active=true]:text-black data-[active=true]:border-primary",
        wallet: "bg-surface-container hover:bg-surface-container-lowest border border-border hover:border-primary/50 group rounded-none",
      },
      size: {
