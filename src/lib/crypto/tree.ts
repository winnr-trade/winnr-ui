...
export const ZERO_LEAF = 9977709361718355927443841912887374985277239800347592634757955768956816784899n;
...
export class MerkleTree {
     ...
     */
    static fromLeaves(levels: number, leaves: { leafIndex: number; commitment: bigint }[]): MerkleTree {
